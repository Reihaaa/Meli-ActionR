...
با توجه به محدودیت‌ها و فیلترینگ اینترنت در kایران، این ریپازیتوری به شما امکان می‌دهد فایل‌های مورد نظرتان را از طریق **گیت‌هاب اکشن** دانلود کنید و داخل خود ریپازیتوری ذخیره کنید.  
